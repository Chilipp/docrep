# -*- coding: utf-8 -*-
#
# docrep documentation build configuration file, created by
...
version = re.match('\d+\.\d+\.\d+', docrep.__version__).group()
# The full version, including alpha/beta/rc tags.
release = docrep.__version__
...
man_pages = [
    (master_doc, 'docrep', u'docrep Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'docrep', u'docrep Documentation',
   author, 'docrep', 'A Python Module for intelligent reuse of docstrings',
   'Miscellaneous'),
]
